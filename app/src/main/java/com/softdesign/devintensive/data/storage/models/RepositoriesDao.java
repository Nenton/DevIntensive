...
*/
public class RepositoriesDao extends AbstractDao<Repositories, Long> {

    public static final String TABLENAME = "REPOSITORIES";

    /**
     * Properties of entity Repositories.<br/>
    ...
    */
    ...
    private Query<Repositories> user_MRepositoriesQuery;

    public RepositoriesDao(DaoConfig config) {
        super(config);
    }
    
    public RepositoriesDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Repositories entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Repositories entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(Repositories entity) {
    ...
    @Override
    public Repositories readEntity(Cursor cursor, int offset) {
        Repositories entity = new Repositories( //
    ...
    @Override
    public void readEntity(Cursor cursor, Repositories entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Repositories entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Repositories entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    public List<Repositories> _queryUser_MRepositories(String userRemoteId) {
        synchronized (this) {
            if (user_MRepositoriesQuery == null) {
                QueryBuilder<Repositories> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.UserRemoteId.eq(null));
                user_MRepositoriesQuery = queryBuilder.build();
            }
        }
        Query<Repositories> query = user_MRepositoriesQuery.forCurrentThread();
